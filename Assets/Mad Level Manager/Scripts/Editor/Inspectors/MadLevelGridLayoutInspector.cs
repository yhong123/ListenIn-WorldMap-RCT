...
public class MadLevelGridLayoutInspector : MadLevelAbstractLayoutInspector {
    ...
    SerializedProperty ignoreInputForIconsOnDifferentPages;
    ...
    protected override void OnEnable() {
        ...
        ignoreInputForIconsOnDifferentPages = serializedObject.FindProperty("ignoreInputForIconsOnDifferentPages");
    ...
    private void IgnoreInput() {
        MadGUI.PropertyField(ignoreInputForIconsOnDifferentPages, "Ignore Other Pages",
            "Ignores input on icons that are on different pages than active.");
    }
