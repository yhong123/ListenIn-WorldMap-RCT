...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    private bool IsInitialized()
    {
        ...
        return m_StoreController != null && m_GooglePlayStoreExtensions != null;
    }
    ...
    public void OnInitialized(IStoreController controller, IExtensionProvider extensions)
    {
        ...
        m_GooglePlayStoreExtensions.SetDeferredPurchaseListener(OnDeferred);
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        {
            Debug.Log(string.Format("***********************ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            //APPROVED, UPDATE SUBSCRIPTION + 1 month
            UpdateSubcription(1);
    ...
    public void UpdateSubcription(int subscriptionPeriod)
    {
        //#SERVER
        //UPDATE USER SUBSCRIPTION
        WWWForm form = new WWWForm();
        form.AddField("id_user", NetworkManager.IdUser);
        form.AddField("period", subscriptionPeriod);
        NetworkManager.SendDataServer(form, NetworkUrl.UrlSqlSubscriptionUpdate, OnSubscriptionSuccessCallback);
    }

    private void OnSubscriptionSuccessCallback(string response)
    {
