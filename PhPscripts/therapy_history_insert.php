...
$therapyblocks = $_POST["tb"];
$therapyblocks_all = $_POST["tbAll"];
$lexicalitem_exposure = $_POST["liExposure"];
//$lexicalitem_complexity = $_POST["liComplexity"];
//$challengeitem_complexity = $_POST["ciComplexity"];
//$cifeatures_complexity = $_POST["cifComplexity"];
...
{
	// update
	$preparedStatement = $dbConnection->prepare('UPDATE therapy_history_xml SET user_profile = :user_profile, therapyblocks = :therapyblocks, therapyblocks_all = :therapyblocks_all, lexicalitem_exposure = :lexicalitem_exposure, cifeatures_history = :cifeatures_history WHERE patient_id = :patient_id');	
	
	$preparedStatement->execute(array('patient_id' => $patient_id, 'user_profile' => $user_profile, 'therapyblocks' => $therapyblocks, 'therapyblocks_all' => $therapyblocks_all, 'lexicalitem_exposure' => $lexicalitem_exposure, 'cifeatures_history' => $cifeatures_history ));
	
}
else
{
	// insert new
	$preparedStatement = $dbConnection->prepare('INSERT INTO therapy_history_xml (patient_id, user_profile, therapyblocks, therapyblocks_all, lexicalitem_exposure, cifeatures_history) VALUES (:patient_id, :user_profile, :therapyblocks, :therapyblocks_all, :lexicalitem_exposure, :cifeatures_history)');
